...
export interface Stats_PS {
  ...
  warning?: string,
  era?: string,
  warnings?: { source: string, warning: string, color: WARNING_COLOR }[],
  eras?: { name: string, era: string }[],
};
...
export class Stats {
  ...
  public control = 0;
  public cost = 0;
  public reqsections = 0;
  public visibility = 0;
  public flightstress = 0;
  public escape = 0;
  public pitchstab = 0;
  public latstab = 0;
  public cooling = 0;
  ...
  public fromJSON(js: Stats_PS, json_version: number) {
    if (js["liftbleed"])
