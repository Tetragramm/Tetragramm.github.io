 ...
 * differ only in the localStorage prefix (storagePrefix() from deployment.ts
 * for the airplane page, "helicopter." for the helicopter page). The entry
 ...
 * page-specific localStorage prefix, including its trailing dot (e.g. "" for
 * the primary builder, "test." for the Test copy, "helicopter.").
 */
