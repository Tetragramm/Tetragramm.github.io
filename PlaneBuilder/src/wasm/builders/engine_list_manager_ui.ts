...
export class EngineListManagerUI {
    ...
    private updateLists(): void {
        ...
        const namesJson = localStorage.getItem(storageKey('engines_names'));
    ...
    private createList(): void {
        ...
        // Add to names list
        listNames.push(name);
        localStorage.setItem(storageKey('engines_names'), JSON.stringify(listNames));

        // Create empty list
        localStorage.setItem(storageKey(`engines.${name}`), JSON.stringify({ engines: [] }));
    ...
    private deleteList(): void {
        ...
        // Remove list data
        localStorage.removeItem(storageKey(`engines.${this.currentList}`));
