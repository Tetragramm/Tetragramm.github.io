...
import { EngineList, SearchAllEngineLists } from "./EngineList.ts";
import { EngineInputs, ENGINE_TYPE } from "./EngineInputs.ts";
...
export class Engine extends Part {
  ...
  constructor(
    ...
    public CanSelectIndex() {
      const elist_temp = engine_list.get(this.elist_idx);
    ...
    public PartStats(): Stats {
      ...
      const torque = this.etype_stats.torque;
