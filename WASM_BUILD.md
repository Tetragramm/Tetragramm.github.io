...
### Webpack WASM Parsing Error

**Symptoms:**
- Error: `Module parse failed: Internal failure: parseVec could not cast the value`
- Error references `/usr/share/nodejs/webpack/` (system webpack)
- Webpack version shows 5.76.1 or older

**Cause:**
System-installed webpack is too old to parse modern WASM features generated by wasm-pack.

**Solution:**
Use local modern webpack (already fixed in package.json):
```bash
# Install local webpack dependencies
npm install
...
**Verification:**
```bash
# Should see webpack 5.90+ instead of 5.76.1
npx webpack --version
```
