...
impl Part for Munitions {
    ...
    fn part_stats(&mut self) -> Stats {
        ...
        stats.reqsections += self.internal_bay_count as f64;
        ...
        let rack_mass = ((ext_bomb_count as f64 / 5.0).ceil()) as f64;
        stats.mass += rack_mass;
        stats.drag += rack_mass;

        // Total bomb mass (bombs + rockets)
        stats.bomb_mass = (self.bomb_count + self.rocket_count) as f64;
