...
impl PulsejetBuilder {
    ...
    fn calc_mass(&self) -> f32 {
        rtz((1.0e-6 + self.temp_mass()) as f64) as f32 + 1.0
    }
    ...
    fn calc_drag(&self) -> f32 {
        ...
        rtz((1.0e-6 + self.temp_mass() + drag + 1.0) as f64) as f32
    }
    ...
    fn calc_fuel_consumption(&self) -> f32 {
        let era = &ERA_TABLE[self.era_sel];
        rtz((1.0e-6 + 1.1 * self.technical_power * era.fuel) as f64) as f32
    }
    ...
    fn calc_rumble(&self) -> i16 {
        ...
        rtz((1.0e-6 + self.technical_power * valve.rumble / (2.0 * era.vibe)) as f64) as i16
    }
    ...
    pub fn design_cost(&self) -> f32 {
        ...
        rtz((1.0e-6 + 1.0 + self.build_quality * (cost + starter_cost)) as f64) as f32
    }
    ...
    pub fn build(&mut self) -> EngineStats {
        ...
        estats.stats.power = self.desired_power as f64;

        // Technical power is 4/3 of desired power
        self.technical_power = rtz((1.0e-6 + self.desired_power as f32 * 4.0 / 3.0) as f64) as f32;
        ...
        estats.stats.mass += estats.rumble as f64;
