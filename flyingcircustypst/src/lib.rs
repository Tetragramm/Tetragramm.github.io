...
mod tests {
    ...
    fn test_basic_biplane_final_deserialize() {
        let mut deserialize = Deserializer::from_lz_string("AAEAjATAdA7MCwAhAhgZwJYGMAEj0AcAbZAOwFNgBAK4WgMFsfqcZBfZoHQAlACwHsSybAFl+AF34AnAEbIArtgBaYMNgAcABl75gAJGABcYACBa1GkzYAIVhw4B-h8FsAoex8-ngPAUNES0nKKKmpaOsAAwADq0QCSPnyCwmKSsgrKqhraurRmlACCUABmxQACAAmMAJBUAPwAAbSNzU32bEwWTp5mHL1RXvb9PZ2mjLa2HhPskXaj3p6zNZaDy6ssAKCe1BZsFuszTJMHSxwA4CdMpwf21JHUdPuMO-uvHk83B0A").expect("From LZ String Failed");
    ...
    fn test_published_final_deserialize() {
        ...
        for (inp_name, inp_lz, out) in izip!(
            ...
            let mut deserialize = Deserializer::from_lz_string(inp_lz.as_str().unwrap())
    ...
    fn test_temp() {
        ...
        let mut deserialize = Deserializer::from_lz_string(lz_in).expect("From LZ String Failed");
        let mut acft = Aircraft::new();
        acft.deserialize(&mut deserialize).unwrap();
        assert_eq!(AircraftType::Airplane, acft.aircraft_type);
